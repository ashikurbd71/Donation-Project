...
const Donationcard = ({donation}) => {
  ...
  <div className="card-body">
    <h2 className= "card-title  text-[16px] bg-[${category_bg}]  font-medium  px-2 lg:w-[35%] w-[42%] text-center border-2" style={{color: `${text_button_bg}`, background :`${category_bg}`}}>{category}</h2>
